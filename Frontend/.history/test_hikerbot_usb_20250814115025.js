...
async function testHikerbotUSBConnection() {
    ...
    // Test 2: Test HIKERBOT camera start
    console.log('');
    console.log('2️⃣ Testing HIKERBOT camera start...');
    try {
        ...
        if (response.ok) {
            ...
            // Test 4: Stop camera after 5 seconds
            setTimeout(async () => {
                try {
                    console.log('');
                    console.log('4️⃣ Stopping HIKERBOT camera...');
            ...
            console.log('9. Make sure you have configured HIKERBOT in camera settings');
        }
    } catch (error) {
